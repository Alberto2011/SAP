...
from sap.model.auth import Group
...
e record, returns HTML or json"""
    ...
    @expose('sap.templates.administrar.proyecto.edit')
    def edit(self, *args, **kw):
        ...
        return dict(value=value, model=self.model.__name__, pk_count=len(pks), lider_options=lideres)

    @without_trailing_slash
    @expose('sap.templates.administrar.proyecto.new')
    ...
    def post(self, *args, **kw):
        ...
        nom=DBSession.query(Proyecto.nombre).filter_by(nombre=kw['nombre']).first()
        ...
        if nom == None:
            ...
            flash("El proyecto ya existe", 'error')
            redirect('/proyectos/new')
